      ...
      <div className="divide-y">
        ...
        <div className="space-y-2 pb-8 pt-6">
          ...
          <p className="leading-7 text-muted-foreground">
            Welcome to my site. I&apos;m Sean, a software engineer with three
            years of professional experience in web development and two years of
            professional experience in machine learning. I have experience
            collaborating in a startup environment, am quick to productivity,
            and continually seek the opportunity to learn.
          </p>
        </div>
        ...
        {/* Latest Posts */}
        <section>
          <div className="w-full space-y-2 pb-8 pt-6">
            <h2 className="text-2xl font-bold leading-9 tracking-tight text-primary">
              Latest Posts 📝
            </h2>
            <ul className="flex w-full flex-col space-y-4">
